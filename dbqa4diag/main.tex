...
% \begin{tcolorbox}[colback=red!15, title=Compiling]
% 1. Hamiltonian evolutions can be transpiled into gates via Trotter Suzuki decompositions.

% 2. All the components of GCI are then compiled into gates via Euler, KAK and (eventually)
% Shannon decompositions\footnote{\href{https://arxiv.org/abs/quant-ph/0308006v3}{Optimal Quantum Circuits for General Two-Qubit Gates
% , Vatan and Williams, 2003.}}.
% \end{tcolorbox}
