...
\begin{frame}{Step back 2: Quantum Machine Learning}
...
\large
\faArrowCircleRight\,\, We want to use QML architectures
for tackling \textbf{Monte Carlo} Integration (MCI) problems. For integrating $g(x)$ \textit{e.g.}:
\begin{equation}
