...
\begin{frame}{Gates}
\large
    \faArrowCircleRight\,\, We can act on qubits with \textbf{unitary operators} represented as \textbf{gates}.
...
\faArrowCircleRight\,\, Yes! The project is \textbf{agnostic} until the moment when the sequence of pulses $P$ is to be implemented.

\pause

\faArrowCircleRight\,\, At this point, it is possible to define a \textbf{custom} \texttt{Platform} object, which deploy the theoretical law into a $P$ which fits our hosted device.
